function [z, x, pi, indices, exitflag, Bmatrix] = simplex1b(A, b, c, m, n, Bmatrix, indices, phase)
...
while true
    ...
    %Leaving variable
    p=findleave1b(Bmatrix,as,xb, indices, phase, n);
    ...
    [Bmatrix,indices,cb]=update1b(Bmatrix,indices,cb,cs,as,s,p);
